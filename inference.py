...
Inference Script for Competition Evaluation

This script loads the trained model and generates recommendations
for the test dataset.

Usage:
    python inference.py --test_data_path <path_to_test_folder>
...
def main():
    ...
    parser.add_argument(
        ...
        help='Path to trained model file (default: models/recommendation_model.pkl)'
    )
    parser.add_argument(
        '--output_dir',
        type=str,
